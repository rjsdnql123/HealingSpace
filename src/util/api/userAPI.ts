...
export function resultComment(name: string, score: number): any {
  const result = [
    {
      ...
      학업: `${name} (이)의 고민은 공부구나 ${name} (이)는 아주 많이 심각하게 우울함을 느끼고 있어.`,
      친구: `${name} (이)의 고민은 친구구나 ${name} (이)는 아주 많이 심각하게 우울함을 느끼고 있어.`,
      취업: `${name} (이)의 고민은 취업이구나 ${name} (이)는 아주 많이 심각하게 우울함을 느끼고 있어.`,
    },
    {
      ...
      친구: `${name} (이)의 고민은 친구구나.. ${name} (이)는 상당히 자주 우울함을 느끼고 있는거 같아.. `,
